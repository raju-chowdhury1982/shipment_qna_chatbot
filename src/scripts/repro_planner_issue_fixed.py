...
def test_planner_tool_flow_fixed():
    print("Testing planner tool flow simulation (FIXED)...")
    ...
    if response.get("tool_calls"):
        ...
        print("4. Second pass calling (WITHOUT tool_choice='none')...")
        # Fixed: Omit tool_choice entirely
